// Electron/renderer/js/runstep/section/resultButtonHandlers.js

export const setupOpenResultFolderButton = (sectionElement) => {
    const openFolderButton = sectionElement.querySelector('#open-result-folder-button');

    if (openFolderButton) {
        openFolderButton.addEventListener('click', async () => {
            console.log("결과 폴더 열기 button clicked.");
            try {
